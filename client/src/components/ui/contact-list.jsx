    ...
    <div className="mt-5">{
        contacts.map((contact) => {
            ...
            onClick={() => handleClick(contact)}>
               <div className="flex gap-5 items-center justify-start text-neutral-300">
                {
                     ...
                     <Avatar className="h-10 w-10  rounded-full overflow-hidden">
                    {
                     ...
                     <div className={`
                        ${selectedChatData && selectedChatData._id === contact._id ? "bg-[#fffff222] border-2 border-white/70" :getColor(contact.color)}
                     uppercase h-10 w-10  text-lg border-[1px] rounded-full flex items-center justify-center `}>
                       { contact.firstName
               ...
               {isChannel && <div className=" h-10 w-10 flex  items-center justify-center rounded-full bg-[#ffffff22]">#</div>}
               {
